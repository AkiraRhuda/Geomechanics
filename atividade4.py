...
"""x = [1093.4, 1744.3, 2395.2]
y = [314, 501, 701]

X = pd.Series(data=x)
Y = pd.Series(data=y)

geomec_classes.MohrCircle(sigma1=X,sigma3=Y, linemodel=False)"""
...
wellDF, top = geomec_classes.Eaton(wellDF, wellinfoDF, name='atividade4', top=36, exponum=3, sumwater=False).start()
...
geomec_classes.Mudweightwindow(wellDF, name='atividade 4', top=top)