...
geomec_classes.Overburden(wellDF, wellinfoDF,name='1', water=0, sumwater=True)
...
geomec_classes.Overburden(wellDF1, wellinfoDF,name='2', water=0, unknownregion=1)

wellDF2 = geomec_classes.Bellotti(wellDF, wellinfoDF, force_condition='consolidated').calculate()
geomec_classes.Overburden(wellDF2, wellinfoDF,name='2.1', water=0, unknownregion=1)
...
wellDF1, wellinfoDF, tensionDF,  gradDF, totalprofDF, water_depth = geomec_classes.Overburden(wellDF1, wellinfoDF,name='2', water=0, unknownregion=1).start()

wellDF2 = geomec_classes.Bellotti(wellDF, wellinfoDF, force_condition='consolidated').calculate()
wellDF2, wellinfoDF2, tensionDF2,  gradDF2, totalprofDF2, water_depth2 = geomec_classes.Overburden(wellDF2, wellinfoDF,name='2.1', water=0, unknownregion=1).start()
...
geomec_classes.Bourgoyne(wellDF, wellinfoDF)
